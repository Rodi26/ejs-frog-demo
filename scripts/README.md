...
**Automatisation GCP (recommandé)** : module Terraform [terraform/gcp-wif-github/README.md](../terraform/gcp-wif-github/README.md) (`terraform apply`).
...
| [iap-wif-bootstrap.sh](iap-wif-bootstrap.sh) | **Phase 2 (alternative shell)** : créer le pool WIF, le provider GitHub OIDC, le compte de service et le binding `roles/iam.workloadIdentityUser` (une fois par projet). |
